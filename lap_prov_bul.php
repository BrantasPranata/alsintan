      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li>Laporan</li>
            <li class="active">Provinsi Bulanan</li>
          </ol>
        </section>
        ...
        <section class="content">
            ...
            <!-- general form elements disabled -->
              <div class="box box-success">
                <div class="box-header">
                    <h3 align="center">Laporan Rencana Panen Provinsi Bulanan</h3>
                </div>
          <div class="box-body">
                  ...
                  <label class="control-label col-md-1">Bulan</label>
					<div class="col-sm-3">
						<select class="form-control" name="bulan" id="bulan">
							...
							<?php
								$qStr = "SELECT * FROM tblm_bulan ORDER BY kd_bulan";
								$qExec = mysqli_query($con,$qStr);
								while($result = mysqli_fetch_array($qExec)){
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped">
                    <thead>                     
                      <tr style="background-color: yellow;">
                        ...
                        <th><p style="text-align:left">Nama Kabupaten</p></th>
                    ...
                    <?php
					  ...
					  <tr style="background-color: yellow;">
                        ...
                        <th><p style="text-align:left">Provinsi</p></th>
			...
			<?php				
				echo ' Simpan format: <a href="lapprovbul_xls.php?prov='.$_POST['prov'].'&tahun='.$_POST['tahun'].'&bulan='.$_POST['bulan'].'&komoditi='.$_POST['komoditi'].'">XLS</a> | ';
				echo '<a href="lapprovbul_pdf.php?prov='.$_POST['prov'].'&tahun='.$_POST['tahun'].'&bulan='.$_POST['bulan'].'&komoditi='.$_POST['komoditi'].'" target="_blank">PDF</a>';					
                }				
            ?>
