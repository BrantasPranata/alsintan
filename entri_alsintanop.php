...
$(document).ready(function() {
	// Jika Select Box id provinsi dipilih
		var provinsi = $('#provinsi').val(); // Ciptakan variabel provinsi
		$.ajax({
          ...
          user_name = '".$_SESSION['username']."' and
				  ...
				  <span data-alertid="example"></span>
					...
					<div class="col-sm-2">
						<select name="provinsi" id="provinsi" class="form-control" >
							...
							<?php
								$qStrpro = "SELECT * FROM tblm_prov WHERE kd_prov='".$_SESSION['wilayah']."' ORDER BY nm_prov";
            ...
            <table id="example2" class="table table-bordered table-striped">
                    ...
                    <?php
					  ...
					  WHERE id_user='".$_SESSION['id_user']."' AND sts=1
					  ORDER BY id_al ";
