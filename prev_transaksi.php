							...
							<div class="col-md-1"></div>
								...
								<select class="form-control-block-level js-example-basic-single"  name="kodemaster" id="kodemaster">
									...
									<?php
										...
										WHERE sts=1 AND kd_kondisi=1 AND kd_status=2
										ORDER BY id_al";
			...
			<div class="form-group">  
					...
					<div class="col-sm-3">
						<select class="form-control" name="provinsi" id="provinsi">
							...
							<?php
								...
								$qExec = mysqli_query($con,$qStr);
								while($result = mysqli_fetch_array($qExec)){
									if ($result['kd_prov']==$_POST['provinsi']) {
              ...
              <div class="form-group">
                <div class="row">
				  ...
				  <div class="col-md-4">
                      <button type="submit" class="btn btn-warning" name="viewall">Tampilkan Semua</button>
                  </div>
                </div>
              </div>
            ...
            <table id="example1" class="table table-bordered table-striped">
					...
					ORDER BY tr_alsintan.tanggal DESC";
                      ...
                      <tr>
						...
						<td><?php echo $hasils['user']; ?></td>
						<td><?php echo $hasils['b']; ?></td>
						<td><?php echo $hasils['kodewil']; ?></td>
