            ...
            <!-- general form elements disabled -->
              <div class="box box-success">
                <div class="box-header">
                    <h3 align="center">Upload BAST Pembayaran</h3>
                </div>
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
              <?php
                ...
                if(isset($_POST['save'])){
					...
					$sql = "SELECT * FROM tblm_prov WHERE kd_prov = '".$_SESSION['wilayah']."'";
					...
					//ECHO $qry1;
					$sql = "SELECT * FROM tbld_bastp WHERE 
					tahun = '".$_POST['tahun']."' AND
					kd_prov = '".$_SESSION['wilayah']."'";
					...
					if ($error == UPLOAD_ERR_OK) {						
						...
						$name = "bastp_".$_POST['tahun'].$_SESSION['wilayah']."_".$idrec.".".$ext;
						try{
						...
						if ($ext != NULL) {
							mysqli_query($con,"UPDATE tbld_bastp SET upload='".$link."' WHERE idx='".$idrec."'");
						}			
					}		
					//echo $qry1 ;
               }
            ...
            <div class="box box-success">
              <div class="box-header"><h3>Detail Data BAST Pembayaran</h3></div>
            ...
            <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                      $query = "SELECT  * FROM tbld_bastp WHERE idx='".$idrec."' ORDER BY idx ";
