      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li>Laporan</li>
            <li class="active">Nasional Bulanan</li>
          </ol>
        </section>
        ...
        <section class="content">
            ...
            <!-- general form elements disabled -->
              <div class="box box-success">
                <div class="box-header">
                    <h3 align="center">Laporan Rencana Panen Nasional Bulanan</h3>
                </div>
          <div class="box-body">
		  ...
		  <div class="form-group">  
            ...
            <table class="table table-bordered table-striped">
                    <thead>                     
                      <tr style="background-color: yellow;">
                        ...
                        <th><p style="text-align:left">Nama Provinsi</p></th>
                    ...
                    <tbody>
                    <?php
                      $query = "SELECT nm_prov, 
						SUM(luas) AS SUMPanen,
						AVG(provitas) AS AVGPanen
						FROM  `tbld_rpanen` 
						WHERE DATE_FORMAT( waktu,  '%Y' ) =  '".$_POST['tahun']."'
					  ...
					  <tr style="background-color: yellow;">
                        ...
                        <th><p style="text-align:left">Nasional</p></th>
			...
			<?php	
				echo ' Simpan format: <a href="lapnasbul_xls.php?tahun='.$_POST['tahun'].'&bulan='.$_POST['bulan'].'&komoditi='.$_POST['komoditi'].'">XLS</a> | ';
				echo '<a href="lapnasbul_pdf.php?tahun='.$_POST['tahun'].'&bulan='.$_POST['bulan'].'&komoditi='.$_POST['komoditi'].'" target="_blank">PDF</a>';
